...
public final class Pix {
    ...
    public static PixPayload newDynamic(String pspUrl, String merchantName, String merchantCity, String txid) {
        return PixPayloadFactory.dynamicPix(pspUrl, merchantName, merchantCity, txid);
    }

    public static PixPayload newStatic(String pixKey, String merchantName, String merchantCity, BigDecimal amount, String txid) {
